...
async function main() {
    ...
    const DELEGATE_ADDRESS = args["delegate-address"] ?? KNOWN_DELEGATE_ADDRESSES[chainId];
    if (!DELEGATE_ADDRESS) {
        console.error(`No --delegate-address provided and no known preset for chain ${chainId}. ` +
